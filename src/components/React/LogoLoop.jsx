 ...
 * @property {(item:any, key:string)=>import('react').ReactNode} [renderItem]
      ...
      () =>
        cx(
          ...
          isVertical
            ...
            : "overflow-x-hidden",
          "[--logoloop-gap:32px]",
          // '[--logoloop-logoHeight:28px]', // Removed default to allow external override
